...
def toDisplay( globalRec ):
    if not globalRec:  return 'null'
    return {
        'latestMetricUpdateForProposal': globalRec.latestMetricUpdateForProposal ,
        'latestMetricUpdateForRequestProposals': globalRec.latestMetricUpdateForRequestProposals ,
        'latestMetricUpdateForAutocomplete': globalRec.latestMetricUpdateForAutocomplete ,
        'latestMetricUpdateForBudget': globalRec.latestMetricUpdateForBudget ,
    }
